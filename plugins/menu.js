...
%m1 *I N F O  C M D* 
%m4 *Ⓟ* = Untuk user premium 
%m4 *Ⓛ* = Menggunakan limit
%m3
%readmore
`.trimStart(),
...
® ${pmenus} DILARANG SPAM BOT | *NANTI KE BLOKIR NOMORNYA*
® ${pmenus} GUNAKAN BOT SEBAIK MUNGKIN | *PASTI FAHAMLAH*
® ${pmenus} RULL ADALAH PEMILIK BOT(ㆁωㆁ)`, rowId: ".donasi", description: `${namebot}`},
	...
	{title: `🎮 ${pmenus} Game`, rowId: ".? game", description: "Gamenya seru seru Lo bang (ㆁωㆁ)"},
	{title: `🧩 ${pmenus} Fun`, rowId: ".? fun", description: "Fitur yang aman untuk keluarga"},
	{title: `🐚 ${pmenus} Kerang`, rowId: ".? kerangajaib", description: "Tanyakan pada ketua club"},
	{title: `📑 ${pmenus} Quotes`, rowId: ".? quotes", description: "Random Inspirasi"},
	{title: `⛩️ ${pmenus} Anime`, rowId: ".? anime", description: "Wibuu (ㆁωㆁ)"},
	...
	{title: `📖 ${pmenus} Al-Quran`, rowId: ".? quran", description: "Tobat (≧▽≦)"},
